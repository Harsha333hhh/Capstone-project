      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white p-8 rounded-lg shadow-md border border-pink-200">
          ...
          {!loading && !error && articles.length === 0 && (
            <p className="text-center text-gray-500 text-lg">No articles available yet.</p>
          )}
          ...
          {!loading && !error && articles.length > 0 && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {articles.map((article) => (
                <div 
                  key={article._id} 
                  className="border border-pink-200 p-4 rounded-lg hover:shadow-lg transition duration-200 cursor-pointer"
